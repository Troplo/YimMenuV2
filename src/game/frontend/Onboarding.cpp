...
namespace YimMenu
{
	...
	void ProcessOnboarding()
	{
		...
		{
			ImGui::TextWrapped("%s",
			    "Welcome to YimMenuV2! You can press INSERT or Ctrl+\\ to open the menu."
			    // " With the introduction of BattlEye, the ability to join and stay in public sessions has been severely limited. "
